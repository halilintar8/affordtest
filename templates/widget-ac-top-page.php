<?php  if( have_rows('content_action_center') ):?>

<section class="section-col ac-top-page">
    <div class="container">
        <div class="action-center block-action-center row">
            <?php $i = 1; while( have_rows('content_action_center') ): the_row();

                $count = count( get_field('content_action_center'));
                // vars
